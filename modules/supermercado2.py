...
# Las primeras 1000 filas son las ventas que se utilizarán.
# Las filas posteriores corresponden a duplicados/anomalías
# y no se consideran.
...
# Las primeras 1000 filas corresponden a las ventas 1-1000.

df_principal["id_venta"] = range(
    1,
    len(df_principal) + 1
)
...
# utilizamos su categoría correspondiente.
...
# Solo utilizamos categorías que identifican
# un único producto.
...
for columna in columnas_numericas:
    ...
    df_principal[columna] = pd.to_numeric(
        df_principal[columna],
        errors="coerce"
    )
...
# (1 - descuento_pct / 100)
#
# Solo se corrige un valor negativo si al convertirlo
# a positivo el total coincide aproximadamente con
# el total original.
...
df_principal["año"] = (
    fecha_temporal.dt.year
    .astype("Int64")
)


df_principal["mes"] = (
    fecha_temporal.dt.month
    .astype("Int64")
)
...
# 25. CREAR AÑO_MES
# Se crea directamente desde la fecha para evitar
# valores como <NA>-<NA> cuando la fecha es desconocida.
